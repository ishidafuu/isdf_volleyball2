...
personality:
  ...
  expression_axis:
    basic_stance:
      ...
      method: "direct"  # 明確なコミュニケーション
    style:
      interpersonal: "guidance"  # 後輩への指導
      situational: "adaptive"  # 状況に応じた柔軟な対応

# Related files
related_files:
  - teams/sakurada-endurance.md
  - relationships/wing-spiker-network.md
---
