...
personality:
  energy_axis:
    ...
    energy_expression: "active"  # 戦術的判断を積極的に実行
    influence_type: "catalyst"  # チーム全体のパフォーマンスを引き出す
    influence_scope: "group"  # チーム全体への影響力を重視

  motivation_axis:
    internal_motivation: 
      primary: "intellectual_curiosity"  # データ分析と戦術研究への強い興味
      secondary: "self_improvement"  # セッターとしての技術向上
    external_motivation:
      primary: "team_contribution"  # チーム全体の戦力最大化
      secondary: "recognition"  # 戦術家としての評価
    behavioral_approach: "analytical"  # データに基づく論理的アプローチ
    interpersonal_style: "leadership"  # キャプテンとしての指揮統率

  information_axis:
    stress_response:
      cognitive: "analytical"  # 状況を論理的に分析
      processing: "overcoming"  # データと分析で解決策を見出す
      coping: "meditation"  # 内的な整理と統合
    learning_style:
  ...
  expression_axis:
    basic_stance:
      ...
      method: "direct"  # 明確な指示と方向性の提示
    style:
      interpersonal: "directive"  # 指導的な立場からの働きかけ
